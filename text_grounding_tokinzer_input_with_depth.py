...
class GroundingNetInput:
    ...
    def prepare(self, batch):
        ...
        return {"boxes":boxes, "masks":masks, "positive_embeddings":positive_embeddings, "depth_info": depth_info}
    ...
    def get_null_input(self, batch=None, device=None, dtype=None):
        ...
        depth_info = th.zeros(batch, self.max_box).type(dtype).to(device)
